# Currently just for graph units, but propose that it could be thinned out significantly and used for general utils that are used in multiple tasks files.
import six
    ...
    def axisinfo(unit, axis):
        ...
        if unit == radians:
            return units.AxisInfo(
                majloc=ticker.MultipleLocator(base=4*np.pi),
